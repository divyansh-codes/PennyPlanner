//This is the Sign in page for our App where users can sign in to their account.
//We are using Clerk's SignIn component to handle the sign in process.
    ...
    <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
      <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
        ...
        <div className="hidden lg:relative lg:block lg:p-12">
          ...
          Quickly enter your details; we've got to track all those epic transactions. Let's see where your money went this time🤔!
          </p>
        </div>
      </section>
